...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,0);
  Lcd_string(&lcd, "POZHILAN V D\n");
  Lcd_cursor(&lcd, 1,2);
  Lcd_string(&lcd, "21222304240118");
  HAL_Delay(500);
  while(1){}
}
void SystemClock_Config(void)
...
## Output screen shots of proteus  :
 ![WhatsApp Image 2024-04-02 at 16 19 22_fc690ca6](https://github.com/POZHILANVD/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/144870498/185a5243-e532-4f6f-9320-1963923fad4f)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![318750503-0a733ee8-98d3-4264-a390-51c086fc0b2f](https://github.com/POZHILANVD/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/144870498/09050103-3fb0-47ab-a6e8-3958a29d2e69)
